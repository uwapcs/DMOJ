...
DATABASES = {
     'default': {
        ...
        'NAME': 'dmoj',
        'USER': 'dmoj',
        'PASSWORD': os.environ["MYSQL_DMOJ_PASSWORD"],
        'HOST': 'mysql',
        'OPTIONS': {
            'charset': 'utf8',
...
DEFAULT_USER_TIME_ZONE='Australia/Perth'
USE_I18N = True
USE_L10N = True
USE_TZ = True
...
EMAIL_HOST_USER = 'uwapcs@gmail.com'
EMAIL_HOST_PASSWORD = os.environ['DMOJ_EMAIL_PASSWORD']
EMAIL_PORT = 587
...
SITE_NAME = 'PCS Online Judge'
SITE_LONG_NAME = 'UWA Programming Competition Society Online Judge'
SITE_ADMIN_EMAIL = 'uwapcs@gmail.com'
